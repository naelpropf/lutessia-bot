...
if __name__ == "__main__":
    # <<< STRESS-TEST H1/H2 + 4 blocs k-fold (2026-08-17), Etape 0 avant
    # n=600, sur BBx2@5000, BB+GFT@5000, BB+GFT@3000. Population source du
    # block-bootstrap RESTREINTE au sous-ensemble chronologique (n reduit
    # a 100 pour rester dans un temps de calcul raisonnable -- controle de
    # robustesse preliminaire, pas la confirmation finale).
    ...
    for label, extra_starter, ceiling in TESTS:
        ...
        for sp_name, sp_pop in subperiods.items():
            ...
            pd.DataFrame(rows).to_csv("chantier_stresstest_pisteAB_2026-08-17.csv", index=False)
