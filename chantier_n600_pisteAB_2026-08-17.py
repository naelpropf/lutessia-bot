...
if __name__ == "__main__":
    # <<< CONFIRMATION n=600+cascade (2026-08-17), APRES stress-test H1/H2+
    # k-fold passe pour les 3 tests (aucune inversion de direction, cf.
    # chantier_stresstest_pisteAB_2026-08-17.csv). Population COMPLETE
    # (pas de sous-periode ici), seed=9999 comme toute la session.
    ...
    for label, extra_starter, ceiling in RUNS:
        ...
        pd.DataFrame(rows).to_csv(f"chantier_n600_pisteAB_2026-08-17.csv", index=False)
