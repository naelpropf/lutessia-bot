...
"""
BALAYAGE 2026-08-17 : plafond personnel entre 1000$ et 3000$, question
ouverte "decision #9" du registre -- le seuil de bascule Blueberry
Instant (bb_threshold) n'a JAMAIS ete calibre pour des plafonds
intermediaires (seuls 960$/5000$ ont une mesure directe, S7.1 ; 1000$ et
3000$ sont EXTRAPOLES par proximite de regime, S1.8). Pour chaque nouveau
plafond teste ici, les 2 regimes deja etablis (bb_th=5000 "tendu" et
bb_th=0 "large") sont TOUS LES DEUX testes -- pas d'hypothese sur lequel
s'applique, mesure directe comme S7.1.
"""
if __name__ == "__main__":
    ...
    BB_THRESHOLDS_TO_TEST = [5000.0, 0.0]  # les 2 regimes deja etablis (S1.8), mesure directe ici

    rows = []
    for ceiling in ceilings_arg:
        for bb_th in BB_THRESHOLDS_TO_TEST:
            t0 = time.time()
            ...
            pd.DataFrame(rows).to_csv(f"chantier_ceiling_sweep_n{n_sims}_2026-08-17.csv", index=False)
